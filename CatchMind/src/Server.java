...
public class Server {
	String[] words = { "맙소사", "바나나", "원숭이", "사람", "책", "기린", "하마", "얼굴", "박명수", "강아지", "게임", "제철소", "우유", "때", "씨앗", "소", "여자", "남자", "아빠", "엄마", "가족", "할머니", "할아버지", "말", "고양이", "닭", "시대", "역사", "퍼센트", "운동", "학교", "대통령", "정부", "돈", "친구", "마음", "순천향대학교", "몸", "신창", "괴물", "노래", "다리", "한강", "오피스텔", "방구석", "라면", "거미", "이야기", "메뚜기", "양궁", "김제덕", "코로나", "유재석", "김치", "먹방", "피아노", "PC방", "컴퓨터", "노트북", "턱걸이", "기차", "무궁화호", "KTX", "학교", "달", "치킨", "짬뽕", "우주", "아이유", "레옹", "뱀", "맥너겟", "돈까스", "칼", "싸이월드", 
